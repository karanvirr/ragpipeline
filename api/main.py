...
app = FastAPI(
    title="Lightweight & Efficient LLM RAG Pipeline",
    description="An optimized API to answer questions about a document using a RAG pipeline.",
    version="1.1.0"
)
...
async def run_rag_pipeline(payload: RequestPayload):
    ...
    answers = await loop.run_in_executor(
        None,
        lambda: [answer_question(q, rag_components) for q in questions]
    )
